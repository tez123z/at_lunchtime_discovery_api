  ...
  module Maps
    ...
    module Configuration
      ...
      VALID_OPTIONS_KEYS = %i[
        end_point format api_key default_language 
        place_text_search_service place_nearby_search_service required_keys
        place_details_service default_params exponential_backoff exponential_backoff_max_retries
      ].freeze
      ...
      #Available Services
      DEFAULT_PLACE_TEXT_SEARCH_SERVICE = 'place/textsearch'
      DEFAULT_PLACE_NEARBY_SEARCH_SERVICE = 'place/nearbysearch'
